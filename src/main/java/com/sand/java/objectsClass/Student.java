...
import com.sand.java.objectsClass.parent.Person;
...
public class Student extends Person {
    ...
    public Student (int rollNo) {
        ...
        // System.out.println(person.defaultName); default outside the package
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Student.COLLEGE);
        s1.display();
        String userAgent = "sjdbvsjhskjsdbvsdGoogleBotjbajhv";
        System.out.println(userAgent.contains("GoogleBot"));
    }
